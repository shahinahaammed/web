...
export type View = "home" | "login" | "orderType" | "menu" | "cart" | "checkout" | "confirmation" | "admin" | "customerAuth" | "customerOrders";
...
export interface Order { orderNumber: string; orderType: OrderType; form: CheckoutForm; items: CartItem[]; subtotal: number; deliveryFee: number; total: number; status: OrderStatus; createdAt: number; customerId?: string; }
